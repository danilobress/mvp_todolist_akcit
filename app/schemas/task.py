...
class TaskCreate(BaseModel):
    ...
    description: str | None = Field(
        default=None, max_length=500, description="Descrição detalhada da tarefa"
    )
...
class TaskUpdate(BaseModel):
    ...
    title: str | None = Field(
        default=None, max_length=100, description="Título principal da tarefa"
    )
    description: str | None = Field(
        default=None, max_length=500, description="Descrição detalhada da tarefa"
    )
    is_completed: bool | None = Field(
        default=None, description="Status de conclusão da tarefa"
    )
    priority: TaskPriority | None = Field(
        default=None, description="Nível de prioridade (ex: Alta, Média, Baixa)"
    )
    ...
    model_config = ConfigDict(
        ...
        json_schema_extra={
            "example": {
                ...
                "description": "Instalar Python, Node.js e configurar a IDE.",
                "is_completed": False,
                "priority": "Média",
            }
        },
