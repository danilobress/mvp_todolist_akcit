...
class TaskService:
    ...
    async def _fetch_and_update_priority_bg(self, task_id: int, title: str, description: str | None) -> None:
        """
        ...
        try:
            ...
            logger.error(f"Erro na background task de prioridade da Tarefa {task_id}: {e}")
    ...
    async def update_task(self, task_id: int, task_update: TaskUpdate) -> TaskResponse | None:
        """
